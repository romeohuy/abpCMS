...
namespace AbpCMS.EntityFrameworkCore
{
    ...
    public class AbpCMSEntityFrameworkCoreModule : AbpModule
    {
        ...
        {
            context.Services.AddAbpDbContext<AbpCMSDbContext>(options =>
            {
            ...
            Configure<AbpDbContextOptions>(options =>
            {
                 ...
                 * See also AbpCMSMigrationsDbContextFactory for EF Core tooling. */
